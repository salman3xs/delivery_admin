...
class AddDish extends StatefulWidget {
  ...
  AddDish({Key? key, required this.resturants}) : super(key: key);
  @override
  ...
  Future upload() async {
    if (pick == 1) {
      ...
      if (addImg.state == TaskState.success) {
        ...
        FirebaseFirestore.instance.collection('dish').add({'name':dishNameController.text,
          'price' : priceController.text,
          'des' : descriptionController.text,
          'resturants':widget.resturants,'imgUrl': url});
      }
    } else {
      FirebaseFirestore.instance
          .collection('dish')
          .add({'name':dishNameController.text,
      'price' : priceController.text,
      'des' : descriptionController.text,
      'resturants':widget.resturants, 'imgUrl': 'no'});
    }
