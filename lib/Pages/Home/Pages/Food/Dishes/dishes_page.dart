...
import 'Components/add_dish.dart';
import 'Components/dish_button.dart';

class DishesPage extends StatelessWidget {
  final String resturantsName;
  const DishesPage({Key? key, required this.resturantsName})
      : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection('dish')
            .where('resturants', isEqualTo: resturantsName)
            .snapshots(),
      ...
      floatingActionButton: FloatingActionButton(onPressed: (){
        showDialog(context: context, builder: (BuildContext context)=>AddDish(resturants: resturantsName,));
